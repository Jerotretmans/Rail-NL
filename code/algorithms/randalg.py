...
def start_stations_rustaaahg():
    ...
    """
    station_names_rustaaahg = ["Den Helder", "Dordrecht"]
    return station_names_rustaaahg

def start_stations_randalg():
    return 
...
def run_randalg(algorithm_instance, regio, aantal_trajecten) -> int:
    ...
    # Random aantal trajecten (twee minder als je bizzey of rustaaahg runt)
    if vaste_start_stations == False:
...
def run_randalg_bizzey(algorithm_instance, regio, aantal_trajecten):
    ...
    start_stations = start_stations_bizzey()

    vaste_start_stations = True

    return run_randalg(algorithm_instance, regio, aantal_trajecten)

def run_randalg_rustaaahg(algorithm_instance, regio, aantal_trajecten):

    start_stations = start_stations_rustaaahg()
